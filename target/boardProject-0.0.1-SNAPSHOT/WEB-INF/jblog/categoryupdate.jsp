...
<form action="/category/update" method="post">
    <input type="hidden" name="blogId" value="${selected.blogId}">
    <input type="hidden" name="categoryId" value="${selected.categoryId}">
    <p>
        <strong>카테고리명:</strong>
        <input type="text" name="categoryName" value="${selected.categoryName}">
    </p>
    <p>
    ...
    <p>
        <strong>포스트 수:</strong>
        <input type="text" name="cntDisplayPost" value="${selected.cntDisplayPost}">개(1~20)
    </p>
    <p>
        <strong>설명:</strong>
